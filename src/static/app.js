  ...
  async function fetchActivities() {
    try {
      ...
      Object.entries(activities).forEach(([name, details]) => {
        ...
        // Attach remove handlers inside this card
          ...
          button.addEventListener("click", async () => {
            ...
            try {
              const response = await fetch(
                `/activities/${encodeURIComponent(activityName)}/participants/${encodeURIComponent(emailToRemove)}`,
                { method: "DELETE" }
              );
              ...
              if (response.ok) {
                ...
                messageDiv.textContent = errorBody.detail || "Failed to remove participant.";
